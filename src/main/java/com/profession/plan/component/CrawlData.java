 ...
 * @Package com.profession.plan.component.CrawlData
 * @Description: 爬虫数据处理类
 * @author 熊正胜
 * @date 2019年3月31日
 * @version V1.0
...
import com.profession.plan.crawlers.AbstractCrawlHandle;
...
import com.profession.plan.util.ApplicationContextUtil;
